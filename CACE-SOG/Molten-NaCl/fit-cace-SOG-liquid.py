...
import datetime
save_folder = "../Molten-NaCl/loss_data/SOG_MP1_"
...
torch.save(cace_nnp.to(device), save_folder+time_name+'pointcharge-model.pth')
cace_nnp.to(device)
...
torch.save(cace_nnp.to(device), save_folder+time_name+'pointcharge-model-2.pth')
cace_nnp.to(device)
...
torch.save(cace_nnp.to(device), save_folder+time_name+'pointcharge-model-3.pth')
...
torch.save(cace_nnp.to(device), save_folder+time_name+'pointcharge-model-4.pth')
